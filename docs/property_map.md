...
| `pitch` (13) | quat | orientation quaternion | VERIFY | rarer than angle/roll; radians about the right axis. Corpus values (10/20/90/120) look like DEGREES, not the documented radians -- needs the unit/convention confirmed before wiring |
